...
class BedrockKnowledgeBase:
    ...
    def __init__(
            ...
            chunking_config=None,  # Added this parameter to pass custom chunking configuration
            suffix=suffix,
            # max_tokens=None,
    ...
    def create_chunking_strategy_config(self, strategy):
        ...
        # Directly use the externally provided configuration if available
        if self.chunking_config:
            print("Using externally provided chunking configuration:")
            print(self.chunking_config)
        ...
        # Return the default configuration for the specified strategy
